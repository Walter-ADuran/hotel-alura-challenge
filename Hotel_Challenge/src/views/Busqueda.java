...
import jdbc.controller.ReservaControlador;
import jdbc.controller.huespedesControlador;
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(filaReservas >=0) {
					...
					JOptionPane.showMessageDialog(null, "favor de verificar");
				}
			}
		});
...
//Código que permite mover la ventana por la pantalla según la posición de "x" y "y"
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
	    ...
	    private void ActualizarReservas() {
	    	...
	    	}, ()-> JOptionPane.showMessageDialog(this, "hubo un error en el registro reservas"));
	    }
	    ...
	    private void actualizarHuespedes() {
	    	...
	    	}, ()-> JOptionPane.showMessageDialog(this, "hubo un error en el registro huespedes"));
